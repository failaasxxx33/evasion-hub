<%@ WebHandler Language="C#" Class="ObjectDataProviderGetTypeSpy" %>
...
/// <summary>
/// 注意：本程序仅供实验学习 ObjectDataProvider类的变种ObjectType-GetType，请勿违法滥用！
/// 来源自.NET高级代码审计反序列化漏洞第12课 Gadget：ObjectDataProvider
/// 链接：https://mp.weixin.qq.com/s/sHKR0zlW2CsphGAmv3_KVA
/// </summary>
public partial class ObjectDataProviderGetTypeSpy : IHttpHandler
{
